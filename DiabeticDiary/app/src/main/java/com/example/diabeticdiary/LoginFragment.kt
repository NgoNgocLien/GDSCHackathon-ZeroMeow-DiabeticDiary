...
class LoginFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val usernameET = view.findViewById<EditText>(R.id.usernameEditText)
        val passwordET = view.findViewById<EditText>(R.id.passwordEditText)

        val goBtn = view.findViewById<Button>(R.id.goButton)
//        val forgotPasswordTV = view.findViewById<TextView>(R.id.forgotPasswordTextView)
